...
Mutex logger_mutex;  // Mutex to protect the logger list:
...
LogMessage &operator<<(LogMessage &lm, const LogItem &m) {
    lm.items.push_back(m);
    return lm;
}
...
LogMessage &operator<<(LogMessage &lm, int16_t m) {
    LogItem msg("msg");
    std::ostringstream s;
    s << m;
    msg.data = s.str();
...
LogMessage &operator<<(LogMessage &lm, uint16_t m) {
    LogItem msg("msg");
    std::ostringstream s;
    s << m;
    msg.data = s.str();
...
LogMessage &operator<<(LogMessage &lm, int32_t m) {
    LogItem msg("msg");
    std::ostringstream s;
    s << m;
    msg.data = s.str();
...
LogMessage &operator<<(LogMessage &lm, uint32_t m) {
    LogItem msg("msg");
    std::ostringstream s;
    s << m;
    msg.data = s.str();
...
LogMessage &operator<<(LogMessage &lm, int64_t m) {
    LogItem msg("msg");
    std::ostringstream s;
    s << m;
    msg.data = s.str();
...
LogMessage &operator<<(LogMessage &lm, uint64_t m) {
    LogItem msg("msg");
    std::ostringstream s;
    s << m;
    msg.data = s.str();
...
LogMessage &operator<<(LogMessage &lm, std::stringstream &m) {
    LogItem msg("stream");
    msg.data.assign(m.str());
    lm.items.push_back(msg);
    return lm;
}

LogMessage &operator<<(LogMessage &lm, std::string &m) {
    LogItem msg("string");
    msg.data.assign(m);
    lm.items.push_back(msg);
    return lm;
...
LogMessage &operator<<(LogMessage &lm, std::string_view &m) {
    LogItem msg("string");
    msg.data.assign(m);
    lm.items.push_back(msg);
    return lm;
...
void LogConsumer::ordered_log(std::shared_ptr<LogMessage> msg, ThreadLogger *logger __attribute__((unused))) {
